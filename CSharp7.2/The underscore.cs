...
namespace c_sharp_7.CSharp7
{
    public class TheUnderscore
    {
        ...
        public static void Process1()
        {
            ...
            Int32 bytes1 = 0b_01001000_01100101_01101100_01101100;
            Int32 bytes2 = 0b_01101111_00100000_01010111_01101111;
            Int32 bytes3 = 0b_01110010_01101100_01100100;

            sb.Append((char)((bytes1 & 0x_FF000000) >> 24));
            sb.Append((char)((bytes1 & 0x_00FF0000) >> 16));
            sb.Append((char)((bytes1 & 0x_0000FF00) >> 8));
            sb.Append((char)((bytes1 & 0x_000000FF)));
